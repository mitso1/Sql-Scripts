...
VALUES
  ...
  ('IS1304','Embedded Systems',15,75,4),
  ('IX1401','Complicated Math',10,128,4),
  ('IV1101','Databased',32,126,7.5);


INSERT INTO course_instance (num_students,study_period,study_year,course_code)
VALUES
  (100,'P3',2026,'IS1307'),
  (148,'P2',2026,'IS1307'),
  (35,'P1',2026,'IS1307'),
...
INSERT INTO employee (skill_set,salary,job_title_id,department_name,personal_number)
VALUES
  ('Good at party','120000',21,'Admin',200012310001),
  ('Epic, Good at party','70000',21,'Electronics',200012310002),
  ('Awsome, Good at party, Epic','70000',21,'Data Science',200012310003),
   ('Based, Epic','40000',24,'Electronics',200012310004),
  ('Based, Good at party, Good at data','50000',24,'Data Science',200012310005),
  ('Good at data, Epic, Awsome','60000',24,'Data Science',200012310006),
  ('Based, Epic, Good at data','55000',25,'Electronics',200012310007),
  ('Awsome, Good at data, Based','60000',25,'HR',200012310008),
  ('Epic, Based','55000',25,'HR',200012310009),
  ('Epic, Good at party','40000',22,'Admin',200012310010),
  ('Based, Good at party','60000',22,'Admin',200012310011),
  ('Awsome, Good at data','40000',22,'Data Science',200012310012),
  ('Based, Epic','60000',24,'Admin',200012310013),
  ('Awsome, Good at data','40000',24,'Admin',200012310014),
  ('Good at party, Based, Epic','45000',24,'Admin',200012310015),
  ('Epic, Based, Awsome','45000',25,'Electronics',200012310016),
  ('Good at data','55000',25,'Data Science',200012310017),
  ('Epic, Good at party','45000',25,'Electronics',200012310018),
  ('Good at party, Based','40000',22,'Electronics',200012310019),
  ('Good at party, Based, Awsome','40000',22,'HR',200012310020),
  ('Based, Good at party','40000',22,'HR',200012310021),
  ('Good at party, Epic','45000',24,'HR',200012310022),
  ('Good at data, Based, Epic','55000',24,'Data Science',200012310023),
  ('Based, Good at data','40000',24,'Electronics',200012310024),
  ('Epic, Good at party','55000',25,'Admin',200012310025),
  ('Based','40000',25,'HR',200012310026),
  ('Epic, Awsome, Based','50000',25,'HR',200012310027),
  ('Good at data','45000',22,'Admin',200012310028),
  ('Good at data, Epic','40000',22,'Electronics',200012310029),
  ('Good at party, Good at data','55000',22,'Data Science',200012310030),
  ('Awsome, Based, Epic','55000',24,'HR',200012310031),
  ('Epic','60000',24,'Electronics',200012310032),
  ('Good at data, Awsome, Good at party','55000',24,'Data Science',200012310033),
  ('Based, Awsome','55000',25,'HR',200012310034),
  ('Based, Good at party','60000',25,'Data Science',200012310035),
  ('Good at party','50000',25,'Electronics',200012310036),
  ('Good at party, Based','40000',22,'Admin',200012310037),
  ('Good at data','60000',22,'HR',200012310038),
  ('Good at data, Awsome','50000',22,'Data Science',200012310039),
  ('Good at party, Epic','40000',24,'Admin',200012310040),
  ('Based, Epic','55000',24,'Electronics',200012310041),
  ('Awsome, Good at party','40000',24,'Data Science',200012310042),
  ('Good at party, Good at data','45000',25,'Admin',200012310043),
  ('Epic, Awsome, Good at data','40000',25,'Admin',200012310044),
  ('Based, Good at data, Epic','60000',25,'HR',200012310045),
  ('Good at party, Good at data','55000',22,'HR',200012310046),
  ('Based, Awsome','40000',22,'Admin',200012310047),
  ('Epic, Good at data','50000',22,'HR',200012310048),
  ('Good at data, Based','55000',24,'HR',200012310049),
  ('Based, Epic','70000',21,'Admin',200012310050);
INSERT INTO employee (skill_set,salary,job_title_id,department_name,personal_number)
VALUES
  ('Awsome','60000',24,'Data Science',200012310051),
  ('Awsome, Good at data, Based','45000',25,'Admin',200012310052),
  ('Based, Awsome','55000',25,'Data Science',200012310053),
  ('Good at data, Good at party','55000',25,'Admin',200012310054),
  ('Awsome, Good at party, Based','60000',22,'Data Science',200012310055),
  ('Good at data, Good at party','60000',22,'Admin',200012310056),
  ('Awsome','40000',22,'Data Science',200012310057),
  ('Good at data, Good at party','55000',24,'Electronics',200012310058),
  ('Based, Good at data, Epic','60000',24,'Electronics',200012310059),
  ('Epic','45000',24,'Admin',200012310060),
  ('Good at party','40000',25,'Data Science',200012310061),
  ('Based, Good at data','50000',25,'HR',200012310062),
  ('Good at party, Epic','60000',25,'Admin',200012310063),
  ('Based','45000',22,'Electronics',200012310064),
  ('Based, Good at data','40000',22,'Admin',200012310065),
  ('Epic','60000',22,'Admin',200012310066),
  ('Epic, Based, Good at data','50000',24,'Electronics',200012310067),
  ('Good at data, Based','50000',24,'Data Science',200012310068),
  ('Good at data, Based','40000',24,'HR',200012310069),
  ('Good at data, Awsome','45000',25,'Admin',200012310070),
  ('Good at party, Good at data, Epic','45000',25,'HR',200012310071),
  ('Based','50000',25,'HR',200012310072),
  ('Good at data, Based, Good at party','40000',22,'HR',200012310073),
  ('Awsome, Based, Good at data','40000',22,'HR',200012310074),
  ('Epic, Based','55000',22,'Admin',200012310075),
  ('Based, Epic','40000',24,'Data Science',200012310076),
  ('Based, Awsome, Epic','40000',24,'Data Science',200012310077),
  ('Good at party, Epic','55000',24,'HR',200012310078),
  ('Good at party','40000',25,'HR',200012310079),
  ('Based','55000',25,'HR',200012310080),
  ('Good at data, Epic','60000',25,'Electronics',200012310081),
  ('Epic, Good at data','60000',22,'Electronics',200012310082),
  ('Epic','55000',22,'Electronics',200012310083),
  ('Good at data, Good at party','55000',22,'Electronics',200012310084),
  ('Awsome','45000',24,'Data Science',200012310085),
  ('Good at data, Based','45000',24,'Data Science',200012310086),
  ('Based, Awsome','45000',24,'Data Science',200012310087),
  ('Based, Good at data','40000',25,'HR',200012310088),
  ('Awsome, Good at party','40000',25,'Admin',200012310089),
  ('Epic, Good at data','60000',25,'Admin',200012310090),
  ('Epic, Good at data','50000',22,'HR',200012310091),
  ('Awsome, Based','50000',22,'Admin',200012310092),
  ('Awsome, Based, Good at party','40000',22,'Admin',200012310093),
  ('Good at data, Good at party','40000',24,'Admin',200012310094),
  ('Good at party, Good at data','50000',24,'Electronics',200012310095),
  ('Good at party, Epic','45000',24,'Admin',200012310096),
  ('Good at party, Good at data, Based','50000',25,'Data Science',200012310097),
  ('Epic, Good at data','40000',25,'Admin',200012310098),
  ('Good at party, Good at data, Epic','45000',25,'Electronics',200012310099),
  ('Based, Good at data','55000',22,'Electronics',200012310100);


INSERT INTO planned_activity (planned_hours,activity_name,course_instance_id)
VALUES
  (24,'Laboration',62),
  (24,'Seminar',60),
  (34,'Laboration',64),
...
INSERT INTO employee_on_activity (activity_instance_id,employment_id)
VALUES
  (2,251),
  (4,251),
  (3,252),
